...
class ListBuilder
{
     ...
     */
    public function __construct(DatabaseAdapter $adapter, string $table, array $description, string $primaryKey)
    {
     ...
     */
    protected function getQueryValidator()
    {
        if (is_null($this->validator)) {
            $this->validator = new QueryValidator($this->description);
        }
